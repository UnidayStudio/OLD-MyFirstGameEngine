...
topMenu.add_command(label='Run...',command=Call_engine)
...
def UpdateNode():
    global MMB_on, lastMousePos, nodeCam, MMB_Click, RMB_Click, DragNode, nodeList, RMB_tap, nodeLogic, lineInput
...
def View_DrawDebug(fps):
    text = ''
    text += 'Frame Per Secound: '+str(int(fps*10)/10)
...
def UD_Draw(pos, scale, rot, texture, fullobj):
    pass
